import { inventario, solicitudes } from "./data.js";
import { buscarIndice, mostrarAlertas, mostrarReportePorPrioridad } from "./utils.js";

console.log("============================================");
console.log("   MOTOR LÓGICO — SALUDLOGÍSTICA");
console.log("============================================\n");
